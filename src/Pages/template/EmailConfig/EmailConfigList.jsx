...
const EmailConigList = () => {
  ...
  const fetchData = async () => {
    try {
      const response = await axios.get(`${base_url}/emailTemplate/get`, {
        params: {
          page: pagination.pageIndex,
          size: pagination.pageSize,
        },
  ...
  const handleDeleteUser = async (userId) => {
   ...
   const columns = [
    ...
    },
    {
      ...
      {
        accessorKey: 'outgoing_mail_server',
        header: 'outgoing_mail_server',
        size: 'auto',
      },
